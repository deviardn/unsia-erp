...
<div class="wrapper">
                ...
                <?php echo MainSidebarMenu::widget([
                    ...
                    'items' => [
                        ...
                        [
                            ...
                            'url' => '#',
                            'icon' => FAS::icon('universal-access', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => (Yii::$app->controller->id == 'employeie'),
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'List'),
                                    'url' => ['/employeie/index'],
                        ...
                        [
                            ...
                            'url' => '#',
                            'icon' => FAS::icon('tag', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                        ...
                        [
                            ...
                            'url' => '#',
                            'icon' => FAS::icon('shopping-cart', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
    ...
    <footer class="main-footer <?php echo $keyStorage->get('adminlte.footer-small-text') ? 'text-sm' : null ?>">
        <strong>&copy; ERP Unsia <?php echo date('Y') ?></strong>
    </footer>
    <!-- /footer -->
